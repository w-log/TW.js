...
(function(root, factory) {
    ...
    TextField.prototype.field_blur = function() {
        ...
        var validate = util.hasClass(self, "validate");
        var search = false;
        ...
        if (self.value.length > 0) {
            util.addClass(self, "dirty");
        } else {
            util.hasClass(self, "valid") ? util.removeClass(self, "valid") : '';
            util.hasClass(self, "invalid") ? util.removeClass(self, "invalid") : '';
            util.hasClass(self, "dirty") ? util.removeClass(self, "dirty") : '';
        }
        ...
        if (util.hasClass(self, "dirty") && search) {
            util.hasClass(self, "invalid") ? util.removeClass(self, "invalid") : '';
            util.addClass(self, "valid");
        } else if (validate && util.hasClass(self, "dirty")) {
            util.hasClass(self, "valid") ? util.removeClass(self, "valid") : '';
            util.addClass(self, "invalid");
        }

        // focus아웃 이벤트시에 active클래스 제거
        util.removeClass(self, "active");
    };
    ...
    SelectBox.prototype.optionExtend = function(litag, Option, input) {
        ...
        if (Option.selected) {
            util.addClass(litag, "selected");
            input.setAttribute("value", litag.getAttribute("value"));
        }

        if (Option.disabled) {
            util.addClass(litag, "disabled");
        }
    ...
    SelectBox.prototype.selectOpen = function(e) {
        ...
        var column_css = util.cssObject(select_column[0]);
        var dropdown_css = util.cssObject(select_dropdown);
        ...
        if (unit[0] === "rem") {
            ...
            htmlCss = util.cssObject(htmlElement);
    ...
    SelectBox.prototype.seleted = function(e) {
        ...
        if (util.hasClass(targetEle, "disabled") || util.hasClass(targetEle.parentElement, "disabled")) {
            return false;
        }
        ...
        if (selectedElement) {
            util.removeClass(selectedElement, "selected");
        }
        ...
        util.addClass(targetEle, "selected");
